import type {Generation, AbilityName, ItemName, StatID, Terrain} from '../data/interface';
...
export function calculateSMSSSV(
  ...
  if (attacker.hasAbility('Parental Bond') && move.hits === 1 && !isSpread) {
    ...
    childDamage = calculateSMSSSV(gen, child, defenderForChild, move, field).damage as number[];
    desc.attackerAbility = attacker.ability;
  }
