  ...
  inGens(9, 9, ({gen, calculate, Pokemon, Move}) => {
    describe('Sitrus Berry', () => {
      ...
      test('should consider grass terrain recovery in berry trigger recover logic', () => {
        ...
        expect(result.desc()).toContain('96.4% chance to 3HKO after Grassy Terrain and Sitrus Berry recovery');
      });

      test('should calculate damage and chance to ko in multihit (3 hits) move with Sitrus Berry', () => {
      ...
      test('should calculate damage and chance to ko in multihit (10 hits) move with Sitrus Berry', () => {
      ...
      test('should show Sitrus Berry recovery with Ripen (50% recovery)', () => {
        ...
        expect(result.desc()).toContain('81-96 (55.4 - 65.7%) -- guaranteed 3HKO after Sitrus Berry recovery');
      });

      test('should NOT show Sitrus Berry recovery if defender has Klutz', () => {
        const attacker = Pokemon('Gholdengo', {
          level: 50,
          evs: {spa: 252},
        });
        const defender = Pokemon('Fidough', {
          level: 50,
          ability: 'Klutz',
          item: 'Sitrus Berry',
          nature: 'Careful',
    ...
    describe('33% Recovery Berries', () => {
      const berries33Percent = ['Figy Berry', 'Wiki Berry', 'Mago Berry', 'Aguav Berry', 'Iapapa Berry'];

      berries33Percent.forEach((berry) => {
        test(`should calculate damage and chance to ko considering ${berry} (25% threshold, 33% recovery)`, () => {
          const attacker = Pokemon('Arcanine-Hisui', {
            level: 50,
            item: 'Choice Band',
            nature: 'Adamant',
          ...
          expect(result.desc()).toContain(`62.7% chance to 3HKO after ${berry} recovery`);
        });

        test(`should calculate damage and chance to ko considering ${berry} with Ripen (66% recovery)`, () => {
          ...
          expect(result.desc()).toContain(`120-142 (82.7 - 97.9%) -- 99.6% chance to 2HKO after ${berry} recovery`);
        });
    ...
    describe('Type-Resist Berries', () => {
      test('should show Occa Berry (Fire) in description and reduce damage from OHKO to 2HKO', () => {
        const attacker = Pokemon('Arcanine-Hisui', {
          level: 50,
          item: 'Choice Band',
          nature: 'Adamant',
        ...
        expect(resultBaseline.desc()).toContain('320-380 (164.9 - 195.8%) -- guaranteed OHKO')
      ...
      test('should show Passho Berry (Water) in description and reduce damage from OHKO to 2HKO', () => {
        ...
        expect(resultBaseline.desc()).toContain('180-216 (89.5 - 107.4%) -- 14.4% chance to OHKO')
      ...
      test('should show Chople Berry (Fighting) in description and reduce damage from OHKO to 2HKO', () => {
        ...
        expect(resultBaseline.desc()).toContain('186-218 (92.5 - 108.4%) -- 43.8% chance to OHKO')
